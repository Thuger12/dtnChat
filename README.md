...
STATUS: not ready
### DTN is chat written in python and fully asynchronious.  Key idea is to work with SOCKET and ASYNCIO in python to make it as minimal as possible.
# Features
...
In the future it will be easy to deal with some security
  ...
  >Make it interactive and real time. Got some THREADING to hide blocking socket problem
